                ...
                <div className="deck-div">
                        ...
                        <div className="card-div">
                            ...
                            <div className="content-div">
                                ...
                                <div className="image-div">
                                    <Chart data={_.map(this.props.twitter.twitterData,function(tweet, index){return{series1:tweet.favorite_count}})} height="150" width="200" padding="25"/>
                                </div>
                            </div>
                    ...
                    <div className="card-div">
                        ...
                        <div className="content-div">
                            ...
                            <div className="image-div">
                                <Chart data={_.map(this.props.twitter.twitterData,function(tweet, index){return{series1:tweet.retweet_count}})} height="150" width="200" padding="25"/>
                            </div>
                        </div>
